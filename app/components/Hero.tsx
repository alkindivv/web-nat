...
const Hero = () => {
  return (
    <section className="relative min-h-screen pt-16 sm:pt-0 flex items-center justify-center overflow-hidden">
      {/* Background gradient */}
      ...
      <div className="layout-container relative z-10 px-4 sm:px-6">
        ...
        >
          ...
          <HiArrowDown className="w-5 h-5 sm:w-6 sm:h-6 text-pink-500" />
        </motion.div>
      </div>
    </section>
  );
